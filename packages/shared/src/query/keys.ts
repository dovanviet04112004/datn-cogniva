export const qk = {
  ...
  thread: (channelId: string, rootId: string) => ['channel', channelId, 'thread', rootId] as const,
  ...
  groupCategories: (groupId: string) => ['group', groupId, 'categories'] as const,
  ...
  groupSearch: (groupId: string, q: string) => ['group', groupId, 'search', q] as const,
  ...
  masteryRecommendations: (limit: number) => ['mastery', 'recommendations', limit] as const,
  ...
  flashcardQueue: (workspaceId?: string) => ['flashcards', 'queue', workspaceId ?? 'all'] as const,
  ...
  tutoringCalendar: (from: string, to: string) => ['tutoring', 'calendar', from, to] as const,
  ...
  libraryDocRelated: (docId: string) => ['library', 'doc', docId, 'related'] as const,
  libraryDocReviews: (docId: string) => ['library', 'doc', docId, 'reviews'] as const,
  libraryDocAnnotations: (docId: string) => ['library', 'doc', docId, 'annotations'] as const,
  libraryDocAtoms: (docId: string) => ['library', 'doc', docId, 'atoms'] as const,
  libraryDocEndorse: (docId: string) => ['library', 'doc', docId, 'endorse'] as const,
  libraryDocPrereq: (docId: string) => ['library', 'doc', docId, 'prereq'] as const,
  libraryDocDuplicates: (docId: string) => ['library', 'doc', docId, 'duplicates'] as const,
  libraryDocDownload: (docId: string) => ['library', 'doc', docId, 'download'] as const,
  ...
  adminGroups: (q: string, status: string) => ['admin', 'groups', q, status] as const,
  adminGroupDetail: (id: string) => ['admin', 'group', id] as const,
  adminConversations: (q: string, email: string) => ['admin', 'conversations', q, email] as const,
  ...
  adminTutoringBookingDetail: (id: string) => ['admin', 'tutoring', 'booking', id] as const,
  adminTutoringReviews: (filterKey: string) => ['admin', 'tutoring', 'reviews', filterKey] as const,
  ...
  workspaceManage: (workspaceId: string) => ['workspace', workspaceId, 'manage'] as const,
} as const;
