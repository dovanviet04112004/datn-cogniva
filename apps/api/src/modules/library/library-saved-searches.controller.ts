/**
 * /api/library/saved-searches — port từ route Next (xem
 * library-saved-searches.service.ts). POST route cũ trả 200 → @HttpCode(200).
 */
...
export class LibrarySavedSearchesController {
  ...
  /** POST — body parse trong service (400 `{error:'Invalid body', details}`). */
  @HttpCode(200)
  @Post()
