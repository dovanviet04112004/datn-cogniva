/**
 * Saved-search bookmarks (Phase 4) — port từ:
 *   apps/web/src/app/api/library/saved-searches/route.ts      (GET/POST)
 *   apps/web/src/app/api/library/saved-searches/[id]/route.ts (DELETE)
 * GIỮ NGUYÊN wire shape (GET trả nguyên row theo thứ tự cột Drizzle schema).
 */
...
import { savedSearchBodySchema } from './dto/library-annotations.dto';

/** Row → wire shape `db.select()` cũ — thứ tự cột packages/db/src/schema.ts. */
