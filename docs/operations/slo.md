...
- **Target:** > 0.85
- **Measurement:** Async eval BullMQ job on production samples
...
- **SLI:** Time from POST /chat → Socket.IO gateway broadcast receive on other client
...
_Last reviewed: 2026-05-11 (Stage 1 baseline). Next review: monthly._
